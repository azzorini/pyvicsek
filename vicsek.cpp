...
Bird::Bird(double x_ = 0, double y_ = 0, double ang = 0)
...
VicsekSimulation::VicsekSimulation(unsigned BirdNumber, double velocity = .03, double ang_noise = 2., double length = 7., int seed = 0)
...
VicsekSimulation::VicsekSimulation(const std::list< std::shared_ptr<Bird> >& birds, double velocity = .03, double ang_noise = 2., double length = 7., int seed = 0)
...
void VicsekSimulation::update(unsigned N_steps = 1) {
	unsigned i;
